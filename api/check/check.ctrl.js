...
const detail = (req, res) => {
    ...
    StudentModel.findById(id, (err, result) => {
        ...
        res.render("check/detail", {result});
    })
};
...
const create = (req, res) => {
    ...
    if (!name || !birth || !tel) return res.status(400).send("입력값 오류입니다.");
...
// 2. MusicModel.create()
    StduentModel.create({ name, birth, tel }, (err, result) => {
...
const showUpdatePage = (req, res) => {
    ...
    StudentModel.findById(id, (err, result) => {
        ...
        res.render("check/update", { result });
    });
};

const showCalendarPage = (req, res) => {
    res.render("check/calendar");
}
module.exports = { list, detail, create, update, remove, checkId, showCreatePage, showUpdatePage, showCalendarPage};